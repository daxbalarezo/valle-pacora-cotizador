          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <input
                ...
                className="w-72 bg-white sm:bg-[#F8FAFC] border border-slate-200/90 rounded-xl px-4 py-2.5 text-xs text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0e692e]/20 focus:border-[#0e692e] transition-all shadow-none"
              />
            </div>
            ...
            <button 
              type="button" 
              className="w-10 h-10 rounded-full bg-[#FFFBEB] hover:bg-amber-100 text-[#D97706] flex items-center justify-center border border-amber-200/50 shadow-none transition-colors"
